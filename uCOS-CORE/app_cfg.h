...
#define  APP_CFG_TASK_Position_PRIO                  6u
#define  APP_CFG_TASK_Combine_PRIO                   7u
#define  APP_CFG_TASK_ProcessVisionData_PRIO         8u
#define  APP_CFG_TASK_Laser_PRIO                     9u
#define  APP_CFG_TASK_Flow_PRIO                      10u
#define  APP_CFG_TASK_DataToPC_PRIO                  11u
#define  APP_CFG_TASK_Battery_PRIO                   13u

#define RemoteMode
#ifdef RemoteMode
    #define  APP_CFG_TASK_ProcessPCData_PRIO             12u
    //#define  APP_CFG_TASK_RemoteControl_PRIO             10u
#endif
#ifndef RemoteMode
    #define  APP_CFG_TASK_ProcessPCData_PRIO             10u
    #define  APP_CFG_TASK_RemoteControl_PRIO             12u
#endif
